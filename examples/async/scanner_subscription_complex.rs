            ...
            Ok(scanner_data_list) => {
                ...
                for data in scanner_data_list {
                    ...
                    println!("Symbol: {} ({})", 
                        ...
                        data.contract_details.contract.contract_id
                    );
                    println!("Name: {}", data.contract_details.long_name);
                    println!("Exchange: {}", data.contract_details.contract.exchange);
                    println!("Industry: {} - {}", 
                        data.contract_details.industry,
                        data.contract_details.category
                    );
                    println!("Market Cap: {}", data.contract_details.market_cap);
