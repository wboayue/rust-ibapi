//! Tick By Tick All Last example
//!
//! # Usage
//!
//! ```bash
//! cargo run --no-default-features --features sync --example tick_by_tick_all_last
//! ```
...
fn main() {
    ...
    let ticks = client.tick_by_tick(&contract, 0).all_last().expect("failed to get ticks");
