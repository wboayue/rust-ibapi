...
fn main() {
    ...
    let matches = Command::new("historical_ticks_mid_point")
        ...
        .arg(arg!(<INTERVAL_START>).required(true).help("time at start of interval for tick. e.g. 20240415T12:00"))
    ...
    let interval_start = PrimitiveDateTime::parse(interval_raw, interval_format).unwrap().assume_offset(local_offset);
    //2023-04-10T23:12
