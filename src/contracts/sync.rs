...
mod tests {
    ...
    fn test_matching_symbols() {
        ...
        let symbols = matching_symbols(&client, "IBM").expect("failed to get matching symbols");
    ...
    fn test_contract_details() {
        ...
        let contract_details = contract_details(&client, &contract).expect("failed to get contract details");
    ...
    fn test_market_rule() {
        ...
        let market_rule = market_rule(&client, 1).expect("failed to get market rule");
