...
fn realtime_bars() {
    ...
    // let mut stub = TransportS(server_versions::SIZE_RULES);
    // let mut client = IBClient::do_connect("", "");

    // client.response_messages = vec!["50|3|9001|1678323335|4028.75|4029.00|4028.25|4028.50|2|4026.75|1|".to_owned()];
