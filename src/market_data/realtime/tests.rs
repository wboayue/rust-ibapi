...
fn realtime_bars() {
    ...
    assert_eq!(
        request_messages[0],
        "50|8|9000|0||FUT|202303|0|||EUREX||EUR|FGBL MAR 23||0|TRADES|1||" // 50|8|9001|495512569|ES|FUT|20230616|0||50|CME||USD|ESM3|ES|0|TRADES|0||
    );
    assert_eq!(request_messages[1], "51|1|9000|");
}
