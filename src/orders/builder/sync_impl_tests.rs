...
mod tests {
    use crate::orders::builder::mock_client::mock::MockOrderClient;
    use crate::orders::builder::{OrderBuilder, BracketOrderBuilder};
    use crate::orders::{Action, OrderState, PlaceOrder, OrderData};
    ...
    impl<'a> crate::orders::builder::OrderBuilder<'a, MockOrderClient> {
        ...
        pub fn submit(self) -> Result<crate::orders::builder::OrderId, Error> {
    ...
    impl<'a> crate::orders::builder::BracketOrderBuilder<'a, MockOrderClient> {
        pub fn submit_all(self) -> Result<crate::orders::builder::BracketOrderIds, Error> {
