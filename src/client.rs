...
use crate::domain::{Contract, ContractDetails, NewsProvider, TagValue};
...
impl Client<'_> {
    ...
    fn request_market_data(contract: &Contract, generic_tick_list: &str, snapshot: bool, regulatory_snapshot: bool, market_data_options: &[TagValue]) {
