...
use crate::{client::test_support::mocks::MockGateway, messages::OutgoingMessages, server_versions};
...
pub fn setup_news_providers() -> MockGateway {
    ...
    gateway.add_interaction(
        ...
        vec![
            ...
            "85\03\0BRFG\0Briefing.com General Market Columns\0BRFUPDN\0Briefing.com Analyst Actions\0DJ-RT\0Dow Jones Real-Time News\0".to_string(),
        ],
    );
