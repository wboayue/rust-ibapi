...
/// DataStream trait defines how to decode messages for a specific subscription type.
///
/// This trait provides:
/// - The message IDs this stream is interested in
/// - How to decode messages into the target type
